...
<body>
    ...
    <section class="design p-4">
        <div class="container">
            <div class="sub-head">
                <h3>FEATURES OF OUR <span> UI & UX DESIGN </span> SERVICES </h3>

                <p>Our team has a rich history in creating intuitive and coherent user experiences, ensuring customers have an enjoyable experience when interacting with your product or website. We provide comprehensive research and analysis to identify user needs and goals, so you can be sure the end product is tailored to your audience.</p>
            </div>
            <div class="row justify-content-evenly">
                <div class="col-lg-2 desi">
                    <div class="design-icn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="72" height="71" viewBox="0 0 72 71">
                            <g fill="none" fill-rule="evenodd" stroke="#682984">
                    ...
                    <p class="design-title">AR experience <br> design</p>
                </div>
                <div class="col-lg-2 desi">
                    <div class="design-icn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="71" height="58" viewBox="0 0 71 58">
                            <g fill="none" fill-rule="evenodd" stroke="#682984" transform="translate(1 1)">
                    ...
                    <p class="design-title">Mobile app UX and UI design services</p>
                </div>
                <div class="col-lg-2 desi">
                    <div class="design-icn">
                    ...
                    <p class="design-title">Cross-platform experiences design</p>
                </div>
                <div class="col-lg-2 desi">
                    <div class="design-icn">
                    ...
                    <p class="design-title">UI and UX consult</p>
                </div>
                <div class="col-lg-2 desi">
                    <div class="design-icn">
                    ...
                    <p class="design-title">Design workshops</p>
                </div>
                <div class="col-lg-2 desi">
                    <div class="design-icn">
                        <svg xmlns="http://www.w3.org/2000/svg" width="72" height="64" viewBox="0 0 72 64">
                            <g fill="none" fill-rule="evenodd" stroke="#682984" stroke-linejoin="round">
                    ...
                    <p class="design-title">Web design services</p>
                </div>
